<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="cEvaluacionWF.aspx.cs" Inherits="EvaluacionWF.Consulta.cEvaluacionWF" %>
     ...
     <div class="container">
        <ul class="nav justify-content-center bg-success">
            <li>
                ...
                <h5 class="text-light">Consulta Evaluaciones</h5>
                <a class="nav-link disabled" href="#" tabindex="-1" aria-disabled="true"></a>
        ...
        <div class="form-group row">
            ...
            <asp:DropDownList ID="DropDrom" runat="server" CssClass="col-2" >
               <asp:ListItem Text="Todo" />
                <asp:ListItem Text="Evaluacion Id" />
                <asp:ListItem Text="Estudiante Id" />
            </asp:DropDownList>
